                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">{!! $k->jawaban !!}</td>
                                                    <td class="text-center align-middle">
                                                        ...
                                                        @else
                                                        <a href="/konsultasi/ubah/{{ Crypt::encrypt($profil->id) }}/{{ Crypt::encrypt($tiket->id) }}/{{ Crypt::encrypt($k->id) }}" class="btn btn-xs btn-tambah disabled" data-placement="right" data-toggle="tooltip" data-original-title="Telah di jawab."><i class="fa fa-check"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @empty

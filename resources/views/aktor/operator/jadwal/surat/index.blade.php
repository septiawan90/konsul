                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="/operator/jadwal/kegiatan/{{ Crypt::encrypt($s->id) }}" class="btn btn-xs btn-outline-success"><i class="fa fa-paste"></i> {{ Statistik::hitungKegiatan($s->id) }}</a>
                                        </td>
                                        <td class="text-center align-middle">
                                            <a href="/operator/jadwal/surat/unduh/{{Crypt::encrypt($s->id)}}" class="btn btn-xs btn-outline-primary"><i class="fa fa-download"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

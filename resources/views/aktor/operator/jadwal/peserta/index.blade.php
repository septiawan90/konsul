                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($p->file)
                                            <a href="{{ $link }}/kegiatan/peserta/unduh/{{ Crypt::encrypt($surat->id) }}/{{ Crypt::encrypt($kegiatan->id) }}/{{Crypt::encrypt($p->id)}}" class="btn btn-xs btn-outline-success" data-placement="top" data-toggle="tooltip" data-original-title="Unduh"><i class="fa fa-download"></i></a>
                                        @endif</td>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="{{ $link }}/kegiatan/peserta/lihat/{{ Crypt::encrypt($surat->id) }}/{{ Crypt::encrypt($kegiatan->id) }}/{{ Crypt::encrypt($p->id) }}" class="btn btn-xs btn-outline-info" data-placement="right" data-toggle="tooltip" data-original-title="Lihat"><i class="fas fa-user"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

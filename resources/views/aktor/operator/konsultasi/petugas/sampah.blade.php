...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <a href="/petugas" class="btn btn-sm btn-primary">Data Petugas</a>
                    |
                    <a href="/petugas/kembalikan_semua" class="btn btn-sm btn-warning">Kembalikan Semua</a>
                </div>
                <div class="col-sm-4">
                    <!-- <form action="/petugas/cari_sampah" method="GET" class="form-inline">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="/petugas/kembalikan/{{ Crypt::encrypt($p->id) }}" class="btn btn-success btn-sm">Kembalikan</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>

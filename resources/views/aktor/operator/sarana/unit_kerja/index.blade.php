    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-2">
                ...
                <div class="col-sm-7">{{ $unit_kerja->links() }}</div>
            </div>
        ...
        <div class="card-footer text-center">
            <h5 class="card-title m-0">
            <small>Hal. ke : {{ $unit_kerja->currentPage() }} | Jumlah: <b class="text-success">{{ $unit_kerja->count() }}</b> / {{ $unit_kerja->total() }} Data</small>
            </h5>

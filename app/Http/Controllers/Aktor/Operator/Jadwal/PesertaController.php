...
use App\Models\Aktor\Operator\Jadwal\Peserta;
...
class PesertaController extends Controller
{
	...
	(
		...
		'link_sampah'       => '',
		'view_utama' 		=> 'aktor/operator/jadwal/peserta/index',
		'view_form' 	 	=> 'aktor/operator/jadwal/peserta/form',
		'view_sampah' 	 	=> '',
		'form_action'   	=> '',
	);
	...
	{
		$this->data['aksi'] 		= "ubah";
		$this->data['form_action'] 	= "/operator/jadwal/kegiatan/peserta/update/".$s_id."/".$k_id."/".$p_id;
	...
	public function update($s_id, $k_id, $p_id, Request $request)
	{
		...
		return redirect('/operator/jadwal/kegiatan/peserta/'.$s_id.'/'.$k_id);
	}

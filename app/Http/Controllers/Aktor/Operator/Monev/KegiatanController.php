...
class KegiatanController extends Controller
{
	...
	(
		...
		'link'         		=> '/operator/monev',
		'link_sampah'       => '',
		'view_utama' 		=> 'aktor/operator/monev/kegiatan/index',
		'view_form' 	 	=> 'aktor/operator/monev/kegiatan/form',
		'view_sampah' 	 	=> '',
		'form_action'   	=> '',
	);
	...
	{
		$this->data['aksi'] 		= "ubah";
		$this->data['form_action'] 	= "/operator/monev/kegiatan/update/".$s_id."/".$k_id;
		$this->data['surat']  		= Surat::find(Crypt::decrypt($s_id));
		$this->data['kegiatan'] 	= Kegiatan::find(Crypt::decrypt($k_id));
	...
	public function update($s_id, $k_id, Request $request)
	{
		...
		return redirect($this->data['link'].'/kegiatan/'.$s_id);
	}
